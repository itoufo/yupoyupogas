...
- **シリーズ全体を要約**：このストーリーシリーズで伝えたいメッセージを1〜2行で
- **共感と安心**：読者が「自分も大丈夫かも」と思える優しい言葉
- **予約導線**：「無料相談はプロフィール欄をご覧ください。今だけ特別に無料！」を自然に含める
- **ハッシュタグ**：#占い #スピリチュアル #恋愛相談 #恋愛サポート #星流命理 #${method} など5〜7個
- 文字数：150〜250文字（改行を使って読みやすく）
...
出力（JSONのみ／説明・コードフェンス禁止）：
{
  ...
  "instagram_caption": "シリーズ全体の要約＋共感＋予約導線＋ハッシュタグを含む150〜250文字のキャプション"
}
